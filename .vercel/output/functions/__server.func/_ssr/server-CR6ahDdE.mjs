...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-UeudCgI3.mjs");
...
const manifest = {
  "98f0a55c7aa1efc469efdd8d083a01aa15393ff1e0ddf0d90d8d6cd5723cfc5e": {
    functionName: "finalizeRegistration_createServerFn_handler",
    importer: () => import("./inscription.functions-CxyVsHsb.mjs")
  },
  "a545897a1d6a034569ba7081a3c11133ff3713b0d5859bf852cb64e59db8bd59": {
    functionName: "dispatchNotification_createServerFn_handler",
    importer: () => import("./notifications.functions-BINelGCY.mjs")
  },
  "b0eb4bf9fd20913ad178e990f5d9cb9e40236263e1eab7a6aae77cc773498ef4": {
    functionName: "loginWithIdentifier_createServerFn_handler",
    importer: () => import("./login.functions-C2XcgGzl.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-D_HcibeE.mjs").then((n) => n.r),
    import("./start-_6wcIG7-.mjs"),
