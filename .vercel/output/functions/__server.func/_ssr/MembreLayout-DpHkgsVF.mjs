...
import { B as Button, c as cn, l as logo } from "./button-BZr7_CTB.mjs";
import { I as Input } from "./input-DaEVlcQ1.mjs";
import { R as Root } from "../_libs/radix-ui__react-separator.mjs";
import { R as Root$1, P as Portal, a as Content, C as Close, T as Title, D as Description, O as Overlay } from "../_libs/radix-ui__react-dialog.mjs";
...
import { f as Bell, J as LogOut, L as LayoutDashboard, a5 as User, x as FileText, a9 as Wallet, H as House, P as PanelLeft, aa as X } from "../_libs/lucide-react.mjs";
...
function MemberSidebar({ me }) {
  const { state } = useSidebar();
  const collapsed = state === "collapsed";
  const pathname = useRouterState({ select: (s) => s.location.pathname });
  const { user, signOut } = useAuth();
  const initials = ((me?.prenoms?.[0] ?? user?.email?.[0] ?? "M") + (me?.nom?.[0] ?? "")).toUpperCase();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Sidebar, { collapsible: "icon", className: "border-r", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarHeader, { className: "border-b px-3 py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/membre", className: "flex items-center gap-2 min-w-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logo, alt: "MUGEC-CI", className: "h-9 w-9 shrink-0 rounded-md object-contain" }),
      !collapsed && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-wider text-muted-foreground", children: "Espace" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-semibold truncate", children: "Membre MUGEC-CI" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarGroup, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarGroupContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenu, { children: NAV_ITEMS.map((item) => {
          const active = pathname === item.to;
          return /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuButton, { asChild: true, isActive: active, tooltip: item.label, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: item.to, className: "flex items-center gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarGroup, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarGroupLabel, { children: "Accès rapide" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarGroupContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenu, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuButton, { asChild: true, tooltip: "Retour au site", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(House, { className: "h-4 w-4 shrink-0" }),
          !collapsed && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Site public" })
        ] }) }) }) }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarFooter, { className: "border-t p-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex items-center gap-2 rounded-lg p-2 ${collapsed ? "justify-center" : "bg-sidebar-accent/40"}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Avatar, { className: "h-9 w-9 ring-2 ring-background", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(MemberAvatarImage, { src: me?.photo_url, alt: "" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarFallback, { className: "text-xs bg-primary text-primary-foreground", children: initials })
      ] }),
      !collapsed && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs uppercase tracking-wider text-muted-foreground", children: "Bonjour" }),
...
function MembreLayout({
  ...
  reactExports.useEffect(() => {
    ...
    supabase.from("members").select("nom, prenoms, photo_url, matricule, statut").eq("user_id", user.id).maybeSingle().then(({ data }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-h-screen w-full", style: { background: "var(--gradient-surface)" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(MemberSidebar, { me }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col min-w-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-30 h-16 border-b bg-background/80 backdrop-blur-xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-full items-center justify-between gap-3 px-4 md:px-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarTrigger, { className: "shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden h-8 w-px bg-border sm:block" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-base font-semibold tracking-tight truncate md:text-lg", children: title }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 shrink-0", children: [
          ...
          me?.statut && /* @__PURE__ */ jsxRuntimeExports.jsx(
            Badge,
            {
