...
const ChartPie = createLucideIcon("chart-pie", __iconNode$R);
...
const FileBadge = createLucideIcon("file-badge", __iconNode$B);
const __iconNode$A = [
  [
    "path",
    {
...
const FileCheck = createLucideIcon("file-check", __iconNode$A);
const __iconNode$z = [
  [
    "path",
    {
